...
class FakeNewsDetector:
    def __init__(self):
        self.model_path = config.MODELS_DIR / "kaggle_fake_news_detector.pkl"
        self.vectorizer_path = config.MODELS_DIR / "kaggle_fake_news_vectorizer.pkl"
        self.model = None
    ...
    def predict(self, text):
        ...
        if fake_probability > 0.7:
            verdict = "Likely Fake"
        elif fake_probability > 0.4 and fake_probability <= 0.7:
            verdict = "Suspicious"
        else:
            verdict = "Likely Real"
