...
def show_homepage():
    ...
    # Add the two new features into their own columns to make 5 total (3 existing + 2 new)
    col1, col_new1, col_new2, col2_orig, col3_orig = st.columns(5)

    with col1: # Original col1 content
        st.markdown("""
    ...
    # NEW FEATURE 1: Text Origin Detector
    with col_new1: 
        st.markdown("""
            <div class="feature-card">
                ...
                <div class="feature-desc">
                    Determine if text was written by a human or generated by an AI model (Text Origin Classifier).
                </div>
            </div>
        """, unsafe_allow_html=True)
        
    # NEW FEATURE 2: Yahoo Answers Classifier
    with col_new2: 
        st.markdown("""
            <div class="feature-card">
                <div class="feature-icon">❓</div>
                <div class="feature-title">Yahoo! Topic C.</div>
                <div class="feature-desc">
                    Classify questions/content into 10 categories from the Yahoo! Answers Topics dataset.
                </div>
            </div>
        """, unsafe_allow_html=True)

    with col2_orig: # Original col2 content
        st.markdown("""
            <div class="feature-card">
                <div class="feature-icon">🔍</div>
    ...
    with col3_orig: # Original col3 content
        st.markdown("""
            <div class="feature-card">
                <div class="feature-icon">✍️</div>
...
def main():
    ...
    if st.session_state.logged_in:
        ...
        # Show features preview - Now using 5 columns
        col1, col_new1, col_new2, col2_orig, col3_orig = st.columns(5)
