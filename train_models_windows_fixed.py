...
def train_yahoo_answers_classifier():
    ...
    try:
        ...
        test_data = load_dataset("csv", data_files=test_path, split='test')
        ...
        print("\n3. Creare TF-IDF vectorizer...")
        vectorizer = TfidfVectorizer(
            max_features=50000, # Am crescut max_features pentru un set de date mai mare
            stop_words='english',
            ngram_range=(1, 2),
            min_df=2,
            max_df=0.8
...
def main():
    ...
    print("5. News Classifier using SVM (AG News)")
    print("0. Ieșire")
